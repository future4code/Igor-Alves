...
import { Label, Title } from "../../style/registerPage";
...
class RegisterPage extends Component {
  ...
  handleDropdownChange = event => {
    ...
    this.setState({ selectCountry: selectedValue})
  }


  render() {
    console.log(this.state.form.paises)
    return (
      <MainContainer>
        <Header>
        ...
        <FormCard>
          ...
          <div>
            <Select name="paises" label="Países" onChange={this.handleInputChange} value={this.state.form.paises}>
          ...
          <Button color="primary" size="large" onClick={this.handleOnSubmit}>Enviar</Button>
        </FormCard>
      </MainContainer>
    );
  }
